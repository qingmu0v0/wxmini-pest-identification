...
export default function AiTech() {
  ...
  return (
    <section id="ai-tech" className="py-20 bg-white">
          ...
          >
            <div className="bg-gradient-to-br from-primary-50 to-accent-50 rounded-2xl p-8 shadow-lg">
              ...
              <div className="mt-6 grid grid-cols-3 gap-4 text-center">
                ...
                <div>
                  <div className="text-2xl font-bold text-primary-600">15s</div>
                  <div className="text-sm text-gray-600">识别速度</div>
                </div>
                <div>
                  <div className="text-2xl font-bold text-primary-600">200+</div>
                  <div className="text-sm text-gray-600">病害种类</div>
                </div>
              </div>
            </div>
          </motion.div>
        ...
        >
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center">
              <div className="text-4xl font-bold text-primary-600 mb-2">100万+</div>
              <p className="text-gray-700 font-medium">训练图像数据</p>
            </div>
            <div className="text-center">
              <div className="text-4xl font-bold text-primary-600 mb-2">50+</div>
              <p className="text-gray-700 font-medium">农业专家参与</p>
            </div>
            <div className="text-center">
              <div className="text-4xl font-bold text-primary-600 mb-2">工作日 9:00-18:00</div>
              <p className="text-gray-700 font-medium">技术支持时间</p>
            </div>
          </div>
        </motion.div>
      </div>
